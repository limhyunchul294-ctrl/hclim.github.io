...
게시판은 **등록된 계정**만 열람할 수 있습니다. 계정·등급 문의는 관리자에게 연락해 주세요.$$,
    ...
    ARRAY['커뮤니티', '등급']::text[],
    24,
    '2025-10-14 15:00:00+09'::timestamptz
);
...
이미지에 워터마크가 표시됩니다. 촬영·외부 공유는 금지입니다.$$,
    ...
    ARRAY['와이어링', 'ETM']::text[],
    31,
    '2025-12-12 11:00:00+09'::timestamptz
);
...
32장(보닛 및 도어)은 아직 PDF가 없습니다.$$,
    ...
    42,
    '2026-02-18 14:00:00+09'::timestamptz
);
...
결과는 참고용이며, 최종 판단은 EVKMC 보증 절차를 따릅니다. 오류 시 VIN·네트워크 확인 후 관리자 문의.$$,
    ...
    ARRAY['보증', 'VIN']::text[],
    19,
    '2026-03-15 10:30:00+09'::timestamptz
);
...
설치 후 아이콘으로 실행하면 주소창 없이 포털이 열립니다. (PDF 오프라인 저장은 되지 않습니다)$$,
    ...
    ARRAY['PWA', '설치']::text[],
    11,
    '2026-05-10 16:00:00+09'::timestamptz
);
...
**QQ**는 5월 업데이트 이후 **이전/다음 챕터**, **이어서 보기**도 이용해 보세요.$$,
    ...
    ARRAY['PDF', '모바일']::text[],
    27,
    '2026-05-18 09:00:00+09'::timestamptz
);
